...
Il **Mane** è la nazione più antica di [**Redentia**](./../../README.md#redentia), anche se è la stessa cosa che il [**Vespera**](./Vespera.md) dice di sè stesso.
Nonostante non si sappia con precisione quando è stato fondato, una cosa è certa: la nazione è più vecchia di tutte quelle che si trovano negli altri continenti, e questo perchè il [**Primo Re**](./../../README.md#il-primo-re) ha fondato sia il **Mane** che il [**Vespera**](./Vespera.md), sebbene non si sappia quale per primo.

Ognuno dei due paesi reclama di esser stato il primo regno creato da [**Redemptus**](./../../README.md#il-primo-re), perchè pensano che questo dia il diritto al trono al proprio regno.
Ovviamente questo è solo una loro supposizione, in quanto la profezia lasciata da [**Redemptus**](./../../README.md#il-primo-re) parla di un suo **Vero Erede** che sarebbe nato intorno all'anno **10000**, ma senza dare altre specifiche.
